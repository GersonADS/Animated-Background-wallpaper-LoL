...
const LUX = {
    ...
    Background: './assets/video/y2meta.com-Cosmic and Dark Cosmic Lux _ Login Screen - League of Legends (Fanmake)-(1080p60).mp4',
    Sound:'./assets/audio/y2meta.com - Interstellar Main Theme - Hans Zimmer (128 kbps).mp3',
    Text: `<h1>Lux</h1>
...
const YASUO = {
    ...
    Background:'./assets/video/y2meta.com-(League of Legends) Blood Moon Yasuo _Animated_ Splash art-(1080p).mp4',
    Sound:'./assets/audio/y2meta.com - Most Epic Battle Music Ever_ _Deadwood_ — Really Slow Motion (320 kbps).mp3',
    Text:`<h1>Yasuo</h1>
...
const AHRI = {
    ...
    Background:'./assets/video/y2meta.com-Desktop Wallpaper Coven Ahri-(1080p60).mp4',
    Sound:'./assets/audio/y2meta.com - Mystery – GoSoundtrack (No Copyright Music) (128 kbps).mp3',
    Text:`<h1>Ahri</h1>
...
let changeText = ()=>{
    Text_.innerHTML = `${responsiveBackground[index].Text}`;
};

let changeBackground = ()=>{
    BackgroundChange.src = `${responsiveBackground[index].Background}`;
};

let changeSound = ()=>{
    SoundChange.src = `${responsiveBackground[index].Sound}`;
};
